...
import { useSiteSetting, PageContentSettings, RegionalSettings } from "@/hooks/useSiteSettings";
...
const Checkout = () => {
  ...
  const { data: regionalSettings } = useSiteSetting<RegionalSettings>("regional");
